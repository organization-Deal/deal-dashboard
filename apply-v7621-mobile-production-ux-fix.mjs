...
const MARK="MOBILE_PRODUCTION_UX_FIX_V7_62_1_20260816";
...
if(!perm.includes(oldTextNode))throw new Error("v7.62.1: หา textNode ของ v7.47 ไม่เจอ");
...
if(!perm.includes(oldPermissionClick))throw new Error("v7.62.1: หา permission click handler ของ v7.47 ไม่เจอ");
...
if(!dash.includes(oldClose))throw new Error("v7.62.1: หา closeMobileMore ไม่เจอ");
...
if(!dash.includes(oldOpen))throw new Error("v7.62.1: หา openMobileMore ไม่เจอ");
...
if(!dash.includes(oldExternal))throw new Error("v7.62.1: หา data-mobile-external handler ไม่เจอ");
...
if(loadPos<0)throw new Error("v7.62.1: หา final load(); ไม่เจอ");
